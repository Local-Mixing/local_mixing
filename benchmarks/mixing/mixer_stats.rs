// Read-only mixing-metric analyzer for post-mix circuits (circuit_mixer / fsplit
...
//
// Example:
//   mixer_stats --input cdcnot_m3000_sm50_circuit_mixer_s1.txt \
//     --origins cdcnot_m3000_sm50_circuit_mixer_s1.origins.txt
use clap::Parser;
...
struct Args {
    ...
    input_format: String,
    /// Origins sidecar (one origin index per line, circuit_mixer --origins-out)
    #[arg(long)]
