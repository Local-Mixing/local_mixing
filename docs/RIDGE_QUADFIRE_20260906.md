...
linearised read. The plates are `docs/blindedv5_quad_pipeline.png`,
`docs/blindedv5_lin_vs_quad.png`, `docs/blindedv5_linear_phaseA_ridge.png`.*
...
The quad-fire plate (`docs/blindedv5_quad_pipeline.png`; side by side with the linear
control in `docs/blindedv5_lin_vs_quad.png`) shows no diagonal at any stage: only the public
