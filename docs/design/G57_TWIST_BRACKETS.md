...
> Markdown rendering of `docs/design/G57_TWIST_BRACKETS.tex`. The PDF is authoritative for figures, diagrams and display math.
...
`docs/design/G57_TWIST_REPLACEMENTS.txt`: **T1**, all 64 minimal
