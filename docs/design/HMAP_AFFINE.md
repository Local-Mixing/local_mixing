...
`security_tests/reporting/plot_hmap_ridge.py` is the canonical reader: it prints per-map scores
...
Usage: `python3 security_tests/reporting/plot_hmap_ridge.py --out plates.png <stem1> [stem2 ...]
