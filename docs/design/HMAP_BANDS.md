...
> Markdown rendering of `docs/design/HMAP_BANDS.tex`. The PDF is authoritative for figures, diagrams and display math.
...
- `security_tests/reporting/hmap_pixels.py` — renders a plate at true 1:1, one
