...
Unlike **new gadgetize** (`docs/history/research/NEW_GADGETIZE.md`), the sliced sandwich uses
...
in `security_tests/support/db_mixing/main_mix_cnot.rs`; flags in `src/main.rs` /
