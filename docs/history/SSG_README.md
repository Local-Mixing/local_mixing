...
local_mixing_bin ssg -n 128 -m 0 -x 10 -s src.txt -d mixed.txt -r 1 \
    ...
    --outgoing-rank-script security_tests/support/rank/outgoing_pareto.rhai \
    --incoming-rank-script security_tests/support/rank/incoming_fanout.rhai --equality_check
```
