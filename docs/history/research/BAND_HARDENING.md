...
> Markdown rendering of `docs/history/research/BAND_HARDENING.tex`. The PDF is authoritative for figures, diagrams and display math.
...
`security_tests/heatmaps/hmap_stat.rs` measures that directly: per cell and target bit,
