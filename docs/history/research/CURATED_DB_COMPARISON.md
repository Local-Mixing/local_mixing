...
Historical campaign: the swapped-controls store and environment override below
refer to the pre-native deployment. Current database builds use `native`
control order; do not copy this campaign's legacy override into a new run.
See [the current GSS database settings](../../GSS_FLAGS.md#database-settings-explained).

*2026-07-31*

> Markdown rendering of `docs/history/research/CURATED_DB_COMPARISON.tex`. The PDF is authoritative for figures, diagrams and display math.
