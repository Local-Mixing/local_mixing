...
> Markdown rendering of `docs/history/research/FMIX_LAYER1.tex`. The PDF is authoritative for figures, diagrams and display math.
...
Design rationale is in `docs/history/research/FMIX_MENU.md`; the ancestry measurements are
in `docs/history/research/ANCESTRY_INSTRUMENTATION.pdf`.
