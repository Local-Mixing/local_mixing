# fmix db_mixing: Structure, Rationale, and the Generation Benchmarks

Current CLI name: `--db-mixing` (formerly `--phase-a`). The historical
measurements below retain their original stage labels and parameters.
