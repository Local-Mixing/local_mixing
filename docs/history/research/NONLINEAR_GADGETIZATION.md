...
> Markdown rendering of `docs/history/research/NONLINEAR_GADGETIZATION.tex`. The PDF is authoritative for figures, diagrams and display math.
...
> `docs/history/research/CARRIER_GADGETIZATION_SUMMARY.tex`. Keep three results distinct: the
