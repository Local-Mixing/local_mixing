...
\begin{center}
\fbox{\parbox{0.92\textwidth}{\textbf{Superseded in part (2026-08-13).}
This document records the July product-mask design.  Current production uses a
single carrier with external mask plan $[2,2,2,3]$ and aggregate Gray; opt-in
nonlinear five-, six-, and seven-carrier modes are summarized in
\texttt{CARRIER\_GADGETIZATION\_SUMMARY}.  Keep three results distinct: the
