...
`docs/history/research/FMIX_MENU.md` §3.3.1, `docs/design/G57_TWIST_BRACKETS.pdf`.
...
regular-only regime: `docs/history/research/CURATED_DB_COMPARISON.pdf` — smaller circuits,
...
Full spec: `docs/design/FMIX_SPLIT_TWIST.md`; measurements:
`reports/split_trials_20260805/` + `docs/history/research/SPLIT_TWIST_REPORT.pdf`. One move
...
`security_tests/reporting/plot_hmap_ridge.py` — by the **ridge** (depth / depthMed / rho), never
...
`security_tests/reporting/band_hardening_20260725/stat_readout.py`, which trims the port rows
...
python3 security_tests/reporting/plot_hmap_ridge.py --out ridge.png ridge     # want depthMed 0, rho ~ 0
