...
> Markdown rendering of `docs/history/research/SINGLE_CARRIER_CONSTRUCTION.tex`. The PDF is authoritative for figures, diagrams and display math.
...
alone — without ever guessing a wire set. `security_tests/leakage/persistence_census.rs`
