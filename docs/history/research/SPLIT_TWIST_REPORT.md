...
> Markdown rendering of `docs/history/research/SPLIT_TWIST_REPORT.tex`. The PDF is authoritative for figures, diagrams and display math.
...
global functional check). Artifacts: spec `docs/design/FMIX_SPLIT_TWIST.md`,
