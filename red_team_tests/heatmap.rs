// PyO3 heatmap surface, extracted from the pre-reorganization src/lib.rs.
// Reconstructed from commit history: the ae160bd5 restructure declared this
// file (via #[path] in src/lib.rs) but did not commit it.
...
#[pyfunction]
pub(crate) fn heatmap_incremental(
    py: Python<'_>,
    num_wires: usize,
    num_inputs: usize,
    flag: bool,
...
#[pyfunction]
pub(crate) fn heatmap_mini_slice(
    py: Python<'_>,
    num_wires: usize,
    num_inputs: usize,
    flag: bool,
...
#[pyfunction]
pub(crate) fn heatmap_corner_at(
    py: Python<'_>,
    num_wires: usize,
    num_inputs: usize,
    flag: bool,
...
#[pyfunction]
pub(crate) fn heatmap_subsampled(
    py: Python<'_>,
    num_wires: usize,
    num_inputs: usize,
    c1: &str,
