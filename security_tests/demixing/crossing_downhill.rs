//! Find locally profitable inverse crossing conjugations using only the released
...
//! R1 crossings expand one cube into a case-split ladder; the reverse
...
#[derive(Parser, Debug)]
#[command(name = "crossing_downhill")]
struct Args {
