...
//!
//! Given a live output half, orient the public circuit-mixer crossing rules so gates
...
fn main() {
    ...
    while moves < args.max_moves && arena.len() < args.max_gates {
        ...
        if moves % 100_000 == 0 {
            eprintln!(
                "[output_cone] moves={} gates={} queue={} swaps={} r1={} r2={} r3={} blocked={}/{}",
                moves,
                arena.len(),
                q.len(),
                stats.swaps,
    ...
    println!(
        "[output_cone] moves={} gates_before={} gates_crossed={} gates_after_prune={} dropped={} queue={} swaps={} r1={} r2={} r3={} presplit={}/{} blocked={}/{} stale={}",
        moves,
        original.len(),
        arena.len(),
        out.len(),
    ...
    println!(
        "[output_cone] verified {} rounds x64 lanes",
        args.verify_rounds
    );
    if let Some(path) = &args.output {
        format::write_mpmct(path, &out, wires).expect("write output circuit");
        println!("[output_cone] wrote {}", path);
    }
}
