...
| `nonlinear193` | `security_tests.gadgetization.nonlinear193` | 193 emitted gates per source gate |
| `nonlinear291` | `security_tests.gadgetization.nonlinear291` | fan-in-at-most-two decomposition, 291 emitted gates per source gate |
