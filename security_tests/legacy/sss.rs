...
pub fn run(sub: &clap::ArgMatches) {
    ...
    println!(
        "python3 ./security_tests/heatmaps/compression_hist.py --csv compression_histogram.csv --out compression_histogram.png"
    );
    println!(
        "python3 ./security_tests/heatmaps/compression_heatmap.py --csv compression_histogram.csv --out compression_heatmap.png"
    );
    println!(
        "python3 ./security_tests/heatmaps/compression_hist.py --csv expansion_histogram.csv --out expansion_histogram.png"
    );
    println!(
        "python3 ./security_tests/heatmaps/compression_heatmap.py --csv expansion_histogram.csv --out expansion_heatmap.png"
    );
    println!(
        "python3 ./security_tests/heatmaps/compression_hist.py --csv expansion_wire_histogram.csv --out expansion_wire_histogram.png"
    );
    println!(
        "python3 ./security_tests/heatmaps/compression_heatmap.py --csv expansion_wire_histogram.csv --out expansion_wire_heatmap.png"
    );
    ...
    println!(
        ...
        python3 ./security_tests/heatmaps/heatmap.py \
        --n {} \
        --i 100 \
        --x \"{}\" \
        --y \"{}\" \
