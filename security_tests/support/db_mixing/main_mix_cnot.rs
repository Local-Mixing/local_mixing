...
use crate::{
    ...
    preprocessing::{
        gadgets::{
            ...
            feistalize_with_slice_zero_cnot, feistalize_with_slice_zero_hardcoded_cnot,
            feistalize_with_slice_zero_random_cnot, gadgetize_cnot, gadgetize_cnot_five_carrier,
            gadgetize_cnot_seven_carrier, gadgetize_cnot_single, gadgetize_cnot_six_carrier,
            gadgetize_cnot_strong_five_carrier, gadgetize_cnot_strong_six_carrier,
            gadgetize_with_slice_zero_ccnot, gadgetize_with_slice_zero_ccnot_five_carrier,
...
#[cfg(test)]
#[path = "../../../tests/unit/legacy/db_mixing/main_mix_cnot/tests.rs"]
mod tests;
