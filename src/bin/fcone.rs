...
use clap::Parser;
use local_mixing::postmix::arena::{Arena, Dir, NIL};
use local_mixing::postmix::compress::liveness_prune;
use local_mixing::postmix::format;
use local_mixing::postmix::rules::{self, BlockReason, Outcome, RuleKind};
use local_mixing::postmix::xgate::{XGate, eval_lanes};
use rand::Rng;
