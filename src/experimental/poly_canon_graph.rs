//! Experimental graph-hashing polynomial canonicalizer.
//!
//! This implementation is retained for comparison and regression research;
//! it is not the authoritative canonicalizer used for database keys.
