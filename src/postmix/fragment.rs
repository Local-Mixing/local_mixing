//! Post-layout fragmentation of wide mixed-polarity conjunction gates.
//!
...
//! deliberately runs after that shuffle: each dirty-helper double sweep stays
//! contiguous, giving the frozen short-window rewriter a coherent local macro
//! instead of a set of ladder rungs dispersed across the circuit.
