//! End-to-end proof of the circuit_mixer frozen-DB contraction move over REAL store
...
#[test]
fn mixer_db_replacement_fires_and_preserves_equivalence() {
    let base = std::env::temp_dir().join(format!("circuit_mixer_dbmove_{}", std::process::id()));
